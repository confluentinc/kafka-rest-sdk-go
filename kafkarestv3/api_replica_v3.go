 ...
 * @return ReplicaData
 */
func (a *ReplicaV3ApiService) ClustersClusterIdTopicsTopicNamePartitionsPartitionIdReplicasBrokerIdGet(ctx _context.Context, clusterId string, topicName string, partitionId int32, brokerId int32) (ReplicaData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return ReplicaDataList
 */
func (a *ReplicaV3ApiService) ClustersClusterIdTopicsTopicNamePartitionsPartitionIdReplicasGet(ctx _context.Context, clusterId string, topicName string, partitionId int32) (ReplicaDataList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
