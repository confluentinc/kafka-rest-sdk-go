...
type BrokerApi interface {
	 ...
	 * @param clusterId The Kafka cluster ID.
	 * @param brokerId The broker ID.
	 * @param optional nil or *ClustersClusterIdBrokersBrokerIdGetOpts - Optional Parameters:
	 * @param "ShouldShutdown" (optional.Bool) -  To shutdown the broker or not, Default: true
	 * @return BrokerData
	 */
	ClustersClusterIdBrokersBrokerIdGet(ctx _context.Context, clusterId string, brokerId int32, localVarOptionals *ClustersClusterIdBrokersBrokerIdGetOpts) (BrokerData, *_nethttp.Response, error)
 ...
 * @return BrokerRemovalData
 */
func (a *BrokerApiService) ClustersClusterIdBrokersBrokerIdDelete(ctx _context.Context, clusterId string, brokerId int32, localVarOptionals *ClustersClusterIdBrokersBrokerIdDeleteOpts) (BrokerRemovalData, *_nethttp.Response, error) {
	var (
...
// ClustersClusterIdBrokersBrokerIdGetOpts Optional parameters for the method 'ClustersClusterIdBrokersBrokerIdGet'
type ClustersClusterIdBrokersBrokerIdGetOpts struct {
	ShouldShutdown optional.Bool
}
 ...
 * @return BrokerData
 */
func (a *BrokerApiService) ClustersClusterIdBrokersBrokerIdGet(ctx _context.Context, clusterId string, brokerId int32, localVarOptionals *ClustersClusterIdBrokersBrokerIdGetOpts) (BrokerData, *_nethttp.Response, error) {
	var (
 ...
 * @return ReplicaDataList
 */
func (a *BrokerApiService) ClustersClusterIdBrokersBrokerIdPartitionReplicasGet(ctx _context.Context, clusterId string, brokerId int32) (ReplicaDataList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return BrokerDataList
 */
func (a *BrokerApiService) ClustersClusterIdBrokersGet(ctx _context.Context, clusterId string) (BrokerDataList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
