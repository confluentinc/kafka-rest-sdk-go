...
type ConfigsApi interface {
	...
	/*
	 * ClustersClusterIdTopicsConfigsGet Get All Topic Configs
	 *
	 ...
	 */
	ClustersClusterIdTopicsConfigsGet(ctx _context.Context, clusterId string) (TopicConfigDataList, *_nethttp.Response, error)
 ...
 * @return TopicConfigDataList
 */
func (a *ConfigsApiService) ClustersClusterIdTopicsConfigsGet(ctx _context.Context, clusterId string) (TopicConfigDataList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
