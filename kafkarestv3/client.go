...
// APIClient manages communication with the Kafka HTTP API API v3.0.0
...
type APIClient struct {
	...
	BalancerStatusApi BalancerStatusApi
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BalancerStatusApi = (*BalancerStatusApiService)(&c.common)
