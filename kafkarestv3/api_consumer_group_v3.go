...
type ConsumerGroupV3Api interface {
	...
	/*
	 * GetKafkaV3ConsumerAssignment Get Consumer Assignment
	 *
	 ...
	 */
	GetKafkaV3ConsumerAssignment(ctx _context.Context, clusterId string, consumerGroupId string, consumerId string, topicName string, partitionId int32) (ConsumerAssignmentData, *_nethttp.Response, error)
	...
	/*
	 * ListKafkaV3ConsumerAssignment List Consumer Assignments
	 *
	 ...
	 */
	ListKafkaV3ConsumerAssignment(ctx _context.Context, clusterId string, consumerGroupId string, consumerId string) (ConsumerAssignmentDataList, *_nethttp.Response, error)
 ...
 * @return ConsumerAssignmentData
 */
func (a *ConsumerGroupV3ApiService) GetKafkaV3ConsumerAssignment(ctx _context.Context, clusterId string, consumerGroupId string, consumerId string, topicName string, partitionId int32) (ConsumerAssignmentData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return ConsumerAssignmentDataList
 */
func (a *ConsumerGroupV3ApiService) ListKafkaV3ConsumerAssignment(ctx _context.Context, clusterId string, consumerGroupId string, consumerId string) (ConsumerAssignmentDataList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
